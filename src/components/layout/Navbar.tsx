...
//                 scrolled
//                   ? 'text-neutral-600 dark:text-neutral-400 hover:bg-brand-50 dark:hover:bg-brand-800'
...
//                 scrolled ? 'text-brand-600 dark:text-accent-300' : 'text-white/90 hover:text-white'
//               }`}
//             >
